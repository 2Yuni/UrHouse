        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelephoneNumber = table.Column<long>(type: "bigint", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartament_Address_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Apartament_Realtor_RealtorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Booking_Apartament_ApartamentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartament_AddressId",
                table: "Apartament",
                column: "AddressId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Apartament_Name",
                table: "Apartament",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_Apartament_RealtorId",
                table: "Apartament",
                column: "RealtorId");
